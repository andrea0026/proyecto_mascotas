...
class User:
    ...
    def save(cls, formulario):
        ...
        result = connectToMySQL('tienda_mascotas').query_db(query, formulario) #1 - Insert recibe id
        return result
    ...
    def get_by_id(cls, formulario):
        ...
        result = connectToMySQL('tienda_mascotas').query_db(query, formulario) #Select recibe lista
        user = cls(result[0])
        return user